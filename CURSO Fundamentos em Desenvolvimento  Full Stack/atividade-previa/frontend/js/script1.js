...
function question02() {
  ...
  const total = recipes.reduce((valor, preco) =>{
    return valor + preco.price / question01();
  }, 0);
...
function question03() {
   ...
   */
   ...
   const valorMaior = [...recipes].sort((a, b) => b.price - a.price);
 
return moneyFormatter.format(valorMaior);
...
function question07() {
   ...
   */
   ...
   const ingred = recipes.includes(item => item);
...
function question10() {
   ...
   */
  const total = recipes.reduce((valor, preco) =>{
    return valor + preco.price  / question01() * 3 * 30;
  }, 0);
